...
UPDATE `maker` SET `URL1` = 'https://www.kadoyahonten.co.jp' WHERE `MakerID` = 'mk0013';
UPDATE `maker` SET `URL1` = 'https://www.mitsubishi-shokuhin.com/liquor/beer/index.html' WHERE `MakerID` = 'mk0015';
