...
<! -------------------------Sbumit -------------------------------->
 <form action = "check/check.php" method = "POST" enctype="multipart/form-data">
...
<option class='hidden' hidden>一つ選んでください</option>
<?php
...
<option hidden>一つ選んでください</option>
<?php
...
<script src="check_control.js"></script>
...
<ul class="image_list_addpro">
<p>写真</p>
<label class="upimg_label" for="upimg"> <input type="file" id="upimg" name="upimg">ファイルを選択する</label>
<span class="msgimg">ファイルが選択されていません</span>
</ul>
<script src="../common/upload_limit.js"></script>
<script src="../common/upimg_filename.js"></script>

<div class="submit"> <input type = "submit" value ="次へ"> </div>
</form>
<! -------------------------Sbumit -------------------------------->
