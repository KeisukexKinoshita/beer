...
for (var i = 0; i < prd_ProductID.length; i++){
     ...
     data_b[i]=({label:prd_ProductName[i],backgroundColor:'black',borderColor:'rgba(0,0,0,0)',title:'title1',data:[{x:prd_IBU[i],y:prd_Color[i],r:prd_Alcohol[i]*0.5}]});
}
console.log(data_b);
  ...
  options: {
    ...
    // events: ['click'],
     ...
     onClick: (e, activeEls) => {
	     ...
	     window.location.href="../../beer/detail/product.php?ProductID="+prd_ProductID[datasetIndex];
             },
           }
});
