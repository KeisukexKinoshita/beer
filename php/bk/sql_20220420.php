...
$prd_Style= array_column($prd,"Style");
...
var prd_ProductID=[], prd_MakerID = [], prd_ProductName = [], prd_Style=[], prd_Alcohol = [], prd_IBU=[], prd_Color=[], prd_Clarity=[], prd_Fruity=[], prd_Favorite=[];
...
//clarity
let js_ = <?php if($json_cla){echo $json_cla;}else{echo '0';} ?>;	 
...
//fruity
let js_ = <?php if($json_fru){echo $json_fru;}else{echo '0';} ?>;	 
